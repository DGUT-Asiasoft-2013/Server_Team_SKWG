...
public class APIController {
	...
	public boolean changePassword(@RequestParam String passwordHash,
	...
	public Boolean passwordRecover(@RequestParam String email, @RequestParam String passwordHash,HttpServletRequest request){
	...
	public Page<Comment> getCommentOfUser(@RequestParam(defaultValue="0") int page,
			HttpServletRequest request) {
		User me = getCurrentUser(request);
	...
	public Comment postComment(@RequestParam String text, @PathVariable int article_id, HttpServletRequest request){
		User me = getCurrentUser(request);
	...
	public Page<Article> searchArticleWithKeyword(
